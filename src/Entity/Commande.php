...
class Commande
{
    ...
    private ?\DateTimeInterface $dateOfCommande = null;
    ...
    public function getDateOfCommande(): ?\DateTimeInterface
    {
        return $this->dateOfCommande;
    }

    public function setDateOfCommande(\DateTimeInterface $dateOfCommande): self
    {
